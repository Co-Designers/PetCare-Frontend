...
@Component({
  selector: 'app-clinic-service-form',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './clinic-service-form.html',
  styleUrls: ['./clinic-service-form.css'],
})
export class ClinicServiceFormComponent implements OnInit {
  private fb = inject(FormBuilder);
  private serviceService = inject(ClinicServiceService);
  private dialogRef = inject(MatDialogRef<ClinicServiceFormComponent>);
